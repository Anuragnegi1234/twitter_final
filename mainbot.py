...
while True:
    user = api.get_user('AnuragN55566063')
    api.update_profile(name=f'anurag|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : anurag|{follower_count(user)} Followers')
